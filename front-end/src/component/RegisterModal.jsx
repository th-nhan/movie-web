        ...
        <div className="w-[800px] h-[600px] bg-white rounded-lg flex">
            ...
            <div className="w-[400px] h-full bg-white rounded-r-lg ">
                <div className="text-black flex flex-col justify-center items-center h-full p-8">
                    ...
                    <input type="email" placeholder='Email...'  className='mb-2 w-full p-4  border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-red-600 transition duration-300'/>
                    ...
                    <input type="text" placeholder='Nhập lại mật khẩu...'  className='mb-2 w-full p-4  border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-red-600 transition duration-300'/>
